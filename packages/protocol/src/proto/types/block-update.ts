...
export class BlockUpdate extends DataType {
	...
	public constructor(position: BlockPosition, runtimeId: number, flags: number, uniqueId: bigint, type: number) {
		super();
  ...
  public static override write(stream: BinaryStream, value: BlockUpdate, _: Endianness ): void {
