...
class UserDataShapelessRecipe extends DataType {
  /**
  ...
  public static read(stream: BinaryStream): UserDataShapelessRecipe {
    // Read the identifier
...
export { UserDataShapelessRecipe };
