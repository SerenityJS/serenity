...
import { AnimateId } from '../enums/index.js';

class AnimateAction extends DataType {
	public static override read(stream: BinaryStream, endian: Endianness, id: AnimateId): number | null {
	...
	public static override write(stream: BinaryStream, value: number | null): void {
