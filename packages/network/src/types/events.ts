...
interface NetworkEvents {
  ...
  [Packet.ServerToClientHandshake]: [NetworkPacketEvent<ServerToClientHandshakePacket>];
  ...
  [Packet.ResourcePackClientResponse]: [NetworkPacketEvent<ResourcePackClientResponsePacket>];
  ...
  [Packet.InventoryTransaction]: [NetworkPacketEvent<InventoryTransactionPacket>];
  ...
  [Packet.ResourcePackDataInfo]: [NetworkPacketEvent<ResourcePackDataInfoPacket>];
  [Packet.ResourcePackChunkData]: [NetworkPacketEvent<ResourcePackChunkDataPacket>];
  [Packet.ResourcePackChunkRequest]: [NetworkPacketEvent<ResourcePackChunkRequestPacket>];
  ...
  [Packet.SetScoreboardIdentity]: [NetworkPacketEvent<SetScoreboardIdentityPacket>];
  [Packet.NetworkStackLatency]: [NetworkPacketEvent<NetworkStackLatencyPacket>];
  [Packet.SetLocalPlayerAsInitialized]: [NetworkPacketEvent<SetLocalPlayerAsInitializedPacket>];
  [Packet.NetworkChunkPublisherUpdate]: [NetworkPacketEvent<NetworkChunkPublisherUpdatePacket>];
  ...
  [Packet.PacketViolationWarning]: [NetworkPacketEvent<PacketViolationWarningPacket>];
  ...
  [Packet.UpdateAdventureSettings]: [NetworkPacketEvent<UpdateAdventureSettingsPacket>];
  [Packet.DeathInfo]: [NetworkPacketEvent<DeathInfoPacket>];
  [Packet.RequestNetworkSettings]: [NetworkPacketEvent<RequestNetworkSettingsPacket>];
  [Packet.SetPlayerInventoryOptions]: [NetworkPacketEvent<SetPlayerInventoryOptionsPacket>];
  [Packet.SetHud]: [NetworkPacketEvent<SetHudPacket>];
  [Packet.AwardAchievement]: [NetworkPacketEvent<AwardAchievementPacket>];
  [Packet.ClientboundCloseForm]: [NetworkPacketEvent<ClientboundCloseFormPacket>];
}
