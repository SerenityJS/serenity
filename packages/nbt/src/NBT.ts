...
class BigIntWrapper{
    ...
    public [NBT_SERIALIZER](m: any, ...params: any[]){m[this[NBT_TYPE] as 4](this.valueOf(), ...params);}
}
...
class NumberWrapper{
    ...
    public [NBT_SERIALIZER](m: any, ...params: any[]){m[this[NBT_TYPE] as 1](this.valueOf(), ...params);}
}
...
// eslint-disable-next-line @typescript-eslint/no-redeclare, func-names
const Byte = function (v: number) { return BaseFunction(v??0, new.target??Byte, (new.target as any)?.[Construct]??NumberWrapper); } as unknown as NBTKindConstructor<Byte>;
// eslint-disable-next-line @typescript-eslint/no-redeclare, func-names
const Int16 = function (v: number) { return BaseFunction(v??0, new.target??Int16, (new.target as any)?.[Construct]??NumberWrapper); } as unknown as NBTKindConstructor<Int16>;
// eslint-disable-next-line @typescript-eslint/no-redeclare, func-names
const Int32 = function (v: number) { return BaseFunction(v??0, new.target??Int32, (new.target as any)?.[Construct]??NumberWrapper); } as unknown as NBTKindConstructor<Int32>;
// eslint-disable-next-line @typescript-eslint/no-redeclare, func-names
const Int64 = function (v: bigint) { return BaseFunction(v??0, new.target??Int64, (new.target as any)?.[Construct]??BigIntWrapper); } as unknown as NBTKindConstructor<Int64>;
// eslint-disable-next-line @typescript-eslint/no-redeclare, func-names
const Float = function (v: number) { return BaseFunction(v??0, new.target??Float, (new.target as any)?.[Construct]??NumberWrapper); } as unknown as NBTKindConstructor<Float>;
// eslint-disable-next-line @typescript-eslint/no-redeclare, func-names
...
const ES_MAPPINGS = [String, Object, Array, Number, BigInt, Boolean, Buffer, Int32Array, Uint32Array, BigInt64Array, BigUint64Array];
const ES_MAP_TYPES = [NBTTag.String, NBTTag.Compoud, NBTTag.List, NBTTag.Int16, NBTTag.Int64, NBTTag.Byte, NBTTag.ByteArray, NBTTag.Int32Array, NBTTag.Int32Array, NBTTag.Int64Array, NBTTag.Int64Array];
...
function RawWriter(this: NBTSerializable, stream: any, ...params: any[]){ stream[this[NBT_TYPE] as 1]((this as any)[NBT_VALUE]??this.valueOf() as any,...params); }
...
export {
    ...
    Byte, Int16, Int32, Int64, Float, Double, List,
    Int32 as Int, Int64 as Long, Int16 as Short,
