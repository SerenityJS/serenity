...
import { 
    NBTTag, NBT_TYPE, NBT_SERIALIZER, ARRAY_TYPE,
    DefinitionReader, DefinitionWriter, 
    Byte
} from "../NBT";

abstract class BinaryStreamDefinitionWriter extends DefinitionWriter{
    public override [NBTTag.Byte](value: number){ this.stream.writeByte(value); }
...
abstract class BinaryStreamDefinitionReader extends DefinitionReader{
    public override [NBTTag.Byte](){ return Byte(this.stream.readByte()); }
    public readonly stream;
    public constructor(stream: BinaryStream){
        super();
        this.stream = stream;
...
abstract class GeneralNBTDefinitionWriter extends BinaryStreamDefinitionWriter{
    ...
    public override writeType(value: number) { this.stream.writeByte(value); }
    ...
    public [NBTTag.ByteArray](value: Buffer): void { this.stream.writeInt32(value.length, Endianness.Little); this.stream.writeBuffer(value); }
    public [NBTTag.Int32Array](value: Int32Array | Uint32Array): void { this.writeArraySize(value.length); for (const i of value) this[NBTTag.Int32](i); }
    public [NBTTag.Int64Array](value: BigInt64Array | BigUint64Array): void { this.writeArraySize(value.length); for (const i of value) this[NBTTag.Int64](i); }
...
abstract class GeneralNBTDefinitionReader extends BinaryStreamDefinitionReader{
    ...
    public override readType(): number { return this.stream.readByte(); }
    ...
    public [NBTTag.ByteArray](): Buffer { return this.stream.readBuffer(this.readArraySize()); }
    public [NBTTag.Int32Array](): Int32Array { const array = new Int32Array(this.readArraySize()); for (let i = 0; i < array.length; i++) array[i] = this[NBTTag.Int32](); return array; }
    public [NBTTag.Int64Array](): BigInt64Array { const array = new BigInt64Array(this.readArraySize()); for (let i = 0; i < array.length; i++) array[i] = this[NBTTag.Int64](); return array; }
}

class NBT{ protected constructor(){}; }
