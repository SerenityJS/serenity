...
class IntTag extends Tag<number> {
  public static readonly type = TagType.Int;
  ...
  public static write(
    ...
    if (varint) stream.writeZigZag(value.value);
    else stream.writeInt32(value.value, Endianness.Little);
  }
}
