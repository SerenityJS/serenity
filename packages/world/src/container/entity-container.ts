...
class EntityContainer extends Container {
   ...
   */
  public constructor(entity: Entity, type: ContainerType, identifier: ContainerId, size: number) {
   ...
   */
  public swapItems(slot: number, otherSlot: number, otherCatainer?: Container): void {
