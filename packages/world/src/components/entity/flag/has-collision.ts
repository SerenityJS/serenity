...
class EntityHasCollisionComponent extends EntityFlagComponent {
	public static readonly identifier = "minecraft:has_collision";

	public static readonly types = [EntityIdentifier.Player];

	public readonly flag = ActorFlag.HasCollision;
	...
	public constructor(entity: Entity) {
		super(entity, EntityHasCollisionComponent.identifier);
...
export { EntityHasCollisionComponent };
