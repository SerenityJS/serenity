...
class SpacerElement extends Element<void> {
  /**
   * Create a new spacer element with the specified options and parent.
   * @param options The options for the spacer element.
   * @param parent The parent object property of the spacer element, or null if it has no parent.
   */
  public constructor(
  ...
  public setVisibility(visible: boolean | Observable<boolean>): this {
    ...
    // NOTE: spacers require an additional property to control the visibility of the button itself, separate from the visibility of the entire element.
    // Create a new boolean property for the visible state of the element, with the name "spacer_visible" and the current element as its parent.
...
export { SpacerElement, SpacerElementOptions };
