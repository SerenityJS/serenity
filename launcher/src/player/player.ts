...
import { EntityAttributeComponent } from "../entity/components/attributes/attribute";
import { Entity } from "../entity";
import { Chunk } from "../world";

import {
	type PlayerComponent,
	type PlayerAttributeComponent,
...
class Player extends Entity {
	...
	public readonly forms: Map<
		number,
		{
			...
			resolve(value: ActionFormResponse | MessageFormResponse): void;
			type: FormType;
		}
	>;
	 ...
	 */
	public getAttributes(): Array<PlayerAttributeComponent> {
		...
		) as Array<PlayerAttributeComponent>;
	}
	...
	public getAbilities(): Array<PlayerAbilityComponent> {
		...
		) as Array<PlayerAbilityComponent>;
	}
